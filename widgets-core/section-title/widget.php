...
class TM_Elementor_Section_Title extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_script( 'tm-section-title-split-text', MASCOT_CORE_CARPENTO_ASSETS_URI . '/js/widgets/section-title-split-text.js' );
	}
	...
	public function get_title() {
		return esc_html__( 'Section Title', 'mascot-core-carpento' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'title_text',
			[
				'label' => esc_html__( "Title Text", 'mascot-core-carpento' ),
		...
		$this->add_control(
			'title_appear_animation', [
				'label' => esc_html__( "Appeared Animation", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->add_control(
			'title_part1_slide_animation', [
				'label' => esc_html__( "On Appeared Slide Animation", 'mascot-core-carpento' ),
		...
		$this->add_control(
			'title_other_part',
			[
				'label' => esc_html__( 'Other Parts', 'mascot-core-carpento' ),
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( "Theme Colored", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$repeater->add_responsive_control(
			'title_bg_img_size',
			[
				'label' => esc_html__( "Background Image Size", 'mascot-core-carpento' ),
		...
		$this->add_control(
			'title_list',
			[
				'label' => esc_html__( "Title Other Parts", 'mascot-core-carpento' ),
		...
		$this->add_control(
			'show_subtitle', [
				'label' => esc_html__( "Show Sub Title", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes'
			]
		);
		$this->add_control(
			'sub_title_text',
			[
				'label' => esc_html__( "Sub Title Text", 'mascot-core-carpento' ),
				"description" => esc_html__( "It will be displayed above/under title", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::TEXTAREA,
				'default' => esc_html__( "This is a Sub Title.", 'mascot-core-carpento' ),
				'condition' => [
		...
		$this->add_control(
			...
			"description" => esc_html__( 'To style particular content element.', 'mascot-core-carpento' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'style1' => esc_html__( 'Style 1 - Default', 'mascot-core-carpento' ),
				],
				'default' => 'style1'
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Horizontal Line Options', 'mascot-core-carpento' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'line_bottom_style',
			[
				'label' => esc_html__( "Horizontal Line Bottom Style", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					''	=> 	esc_html__( "No", 'mascot-core-carpento' ),
					'line-left-current-theme'	=> 	esc_html__( "Style Left - Current Theme", 'mascot-core-carpento' ),
					'line-left-current-theme-white'	=> 	esc_html__( "Style Left - Current Theme White", 'mascot-core-carpento' ),
					'line-right-current-theme'	=> 	esc_html__( "Style Right - Current Theme", 'mascot-core-carpento' ),
					'line-right-current-theme-white'	=> 	esc_html__( "Style Right - Current Theme White", 'mascot-core-carpento' ),
					'line-center-current-theme'	=> 	esc_html__( "Style Center - Current Theme", 'mascot-core-carpento' ),
					'line-center-current-theme-white'	=> 	esc_html__( "Style Center White - Current Theme", 'mascot-core-carpento' ),
				],
				'default' => ''
			]
		);
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Line Horizontal Alignment', 'mascot-core-carpento'),
				'type' => Controls_Manager::CHOOSE,
				'default' => 'left',
				'options' => [
					'left' => [
		...
		$this->add_responsive_control(
			'vertical_line_align',
			[
				'label' => esc_html__('Line Vertical Alignment', 'mascot-core-carpento'),
				'type' => Controls_Manager::CHOOSE,
				'default' => 'bottom',
				'options' => [
					'bottom' => [
						'title' => esc_html__('Bottom', 'mascot-core-carpento'),
						'icon' => 'eicon-v-align-bottom',
					],
					'top' => [
						'title' => esc_html__('Top', 'mascot-core-carpento'),
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('After', 'mascot-core-carpento'),
			]
		);
		$this->add_control(
			'horizontal_line_after_bg_color',
			[
				'label' => esc_html__( "Color (After)", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Theme Color (After)", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_carpento_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Before', 'mascot-core-carpento'),
			]
		);
		$this->add_control(
			'horizontal_line_before_bg_color',
			[
				'label' => esc_html__( "Color (Before)", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Theme Color (Before)", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_carpento_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_section(
			'title_icon_options',
			[
				'label' => esc_html__( 'Title Icon', 'mascot-core-carpento' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'show_title_icon',
			[
				'label' => esc_html__( "Show Title Icon?", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'options' => [
					...
					'icon-left'  => esc_html__( 'Left of Subtitle', 'mascot-core-carpento' ),
				],
				'default' => 'icon-top',
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Icon Custom Width", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => ['px', 'em', '%'],
				'range' => [
					'px' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Title Text Color (Hover)", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Title Theme Colored (Hover)", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_carpento_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Title Background Image Options', 'mascot-core-carpento' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_group_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Sub Title Styling', 'mascot-core-carpento' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			'subtitle_text_color',
			[
				'label' => esc_html__( "Sub Title Text Color", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Sub Title Text Color (Hover)", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Sub Title Theme Colored", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_carpento_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Sub Title Theme Colored (Hover)", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_carpento_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_responsive_control(
			'subtitle_margin',
			[
				'label' => esc_html__( 'Sub Title Margin', 'mascot-core-carpento' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Title Shadow Text', 'mascot-core-carpento' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__( "Title Shadow Text", 'mascot-core-carpento' ),
				"description" => esc_html__( "It will be displayed behind the title as a big blurred gray text", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::TEXT,
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__( "Enable Text Textillate Animation on Text?", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Title Shadow Text Styling', 'mascot-core-carpento' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_group_control(
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Text Container Width", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => ['px', 'em', '%'],
				'range' => [
					'px' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Position', 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Paragraph Theme Colored", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_carpento_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Paragraph Theme Colored (Hover)", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_carpento_theme_color_list(),
				'default' => '',
				'selectors' => [
	...
	protected function render() {
		...
		$html = mascot_core_carpento_get_widgetcore_template_part( 'section-title-' . $settings['design_style'], null, 'section-title/tpl', $settings, true );
