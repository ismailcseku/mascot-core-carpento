<div class="tm-sc-progress-bar <?php echo esc_attr(implode(' ', $classes)); ?>" data-percent="<?php echo esc_attr( $percentage_value );?>" data-unit-left="<?php echo esc_attr( $unit_symbol_left );?>" data-unit-right="<?php echo esc_attr( $unit_symbol_right );?>">
