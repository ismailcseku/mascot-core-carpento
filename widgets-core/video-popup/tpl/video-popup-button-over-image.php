...
<div class="box-hover-effect play-video-button tm-sc-video-popup tm-sc-video-popup-button-over-image <?php echo esc_attr(implode(' ', $classes)); ?>">
	<div class="effect-wrapper">
		...
		<div class="text-holder video-button-holder pre-packaged-play-btn">
			<a data-lightbox="iframe" href="<?php echo esc_html( $popup_video_url  ); ?>" title="<?php echo esc_attr( $title  ); ?>">
				<img class="" src="<?php echo esc_url( PARITY_MASCOT_ASSETS_URI . '/images/video-play-btn/' . $button_over_image_pre_packaged_play_btn );?>" alt="<?php esc_attr_e( 'Image', 'mascot-core-carpento' ); ?>">
			</a>
		</div>
		<?php } else { ?>
