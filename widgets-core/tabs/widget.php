<?php
namespace MascotCoreCarpento\Widgets\Tabs;
...
class TM_Elementor_Tabs extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-tabs-style', MASCOT_CORE_CARPENTO_ASSETS_URI . '/css/widgets-core/tabs' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'TM Tabs', 'mascot-core-carpento' );
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'expand',
			[
				'label' => esc_html__( "Make It Active/Expand?", 'mascot-core-carpento' ),
		...
		$repeater->add_control(
			'tabs_tab_icon_type',
			[
				'label' => esc_html__( 'Add Icon/Image', 'mascot-core-carpento' ),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => false,
				'options' => [
					'' => [
						'title' => esc_html__( 'None', 'mascot-core-carpento' ),
						'icon' => 'fa fa-ban',
					],
					'font' => [
						'title' => esc_html__( 'Icon', 'mascot-core-carpento' ),
						'icon' => 'far fa-smile',
					],
					'image' => [
						'title' => esc_html__( 'Image', 'mascot-core-carpento' ),
						'icon' => 'fa fa-image',
					]
				],
				'default' => '',
		...
		$repeater->add_control(
			...
			[
				...
				'description' => esc_html__('Select icon from Fontawesome library.', 'mascot-core-carpento'),
			]
		);
		$repeater->add_control(
		...
		$repeater->add_control(
			'tabs_content_type',
			[
				'label' => esc_html__('Content Type', 'mascot-core-carpento'),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'content' => esc_html__('Content', 'mascot-core-carpento'),
					'template' => esc_html__('Elementor Templates', 'mascot-core-carpento'),
				],
				'default' => 'content',
			]
		);
		$repeater->add_control(
			...
			[
				'label' => esc_html__('Choose Elementor Template', 'mascot-core-carpento'),
				'type' => Controls_Manager::SELECT,
				'options' => mascot_core_carpento_get_elementor_templates(),
				'condition' => [
		...
		$repeater->add_control(
			'tabs_content',
			[
				'label' => esc_html__('Tab Content', 'mascot-core-carpento'),
				'type' => Controls_Manager::WYSIWYG,
				'default' => esc_html__( "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.", 'mascot-core-carpento' ),
				'dynamic' => [ 'active' => true ],
				'condition' => [
		...
		$this->add_control(
			'tabs_items',
			[
				'label' => esc_html__( "Item", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'title_field' => '{{{ title }}}',
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'title' => __( 'Title 1', 'mascot-core-carpento' ),
						'expand' => 'yes',
					],
					[
						'title' => __( 'Title 2', 'mascot-core-carpento' ),
					],
					[
						'title' => __( 'Title 3', 'mascot-core-carpento' ),
					],
				],
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Tab Block - Width/Alignment', 'mascot-core-carpento' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Each Tab Block Width", 'mascot-core-carpento' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Each Title + Icon/Image Alignment', 'mascot-core-carpento' ),
		...
		$this->add_responsive_control(
			'tabs_icon_position',
			[
				'label' => esc_html__('Icon/Image & Title Position', 'mascot-core-carpento'),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => false,
				'options' => [
					'column' => [
		...
		$this->add_responsive_control(
			'title_flex_vertical',
			[
				'label' => esc_html__( "Title + Icon Vertical Alignment", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Title + Icon Horizontal Alignment", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_carpento_disply_flex_horizontal_align_elementor(),
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Tab Block - Styling', 'mascot-core-carpento' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
				'condition' => [
					'_skin' => '',
				],
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Idle', 'mascot-core-carpento'),
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Falling Shutter Height", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ '%' ],
				'default' => [
					'unit' => '%',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Border Color Options', 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			'title_styling',
			[
				'label' => esc_html__( 'Title (Tab)', 'mascot-core-carpento' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
				'condition' => [
					'_skin' => '',
				],
		...
		$this->start_controls_section(
			'section_style_icon',
			[
				'label' => esc_html__('Icon (Tab)', 'mascot-core-carpento'),
		...
		$this->add_responsive_control(
			'tabs_icon_size',
			[
				'label' => esc_html__('Icon Font Size', 'mascot-core-carpento'),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Icon Image Width', 'mascot-core-carpento'),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 26,
					'unit' => 'px',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Content Background Color', 'mascot-core-carpento'),
				'type' => Controls_Manager::COLOR,
				'dynamic' => [ 'active' => true ],
				'selectors' => [
	...
	protected function render() {
		...
		$settings['holder_id'] = mascot_core_carpento_get_isotope_holder_ID('tabs');
		...
		?>
			...
			<?php
				foreach (  $settings['tabs_items'] as $item ) {
					...
					$html .= mascot_core_carpento_get_widgetcore_template_part( 'tab-title', null, 'tabs/tpl', $settings, false );
					$i++;
				}
			?>
			</ul>
		...
		?>
			...
			<?php
				foreach (  $settings['tabs_items'] as $item ) {
					...
					//Produce HTML version by using the parameters (filename, variation, folder name, parameters, shortcode_ob_start)
					$html .= mascot_core_carpento_get_widgetcore_template_part( 'tab-content', null, 'tabs/tpl', $settings, false );
					$i++;
				}
			?>
			</div>
