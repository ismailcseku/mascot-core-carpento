<?php
namespace MascotCoreCarpento\Widgets\InfoBox\Skins;
...
class Skin_style9 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style 9', 'mascot-core-carpento' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-info-box-style9', MASCOT_CORE_CARPENTO_ASSETS_URI . '/css/widgets-core/info-box/info-box-skin9' . $direction_suffix . '.css' );
		...
		$html = mascot_core_carpento_get_widgetcore_template_part( 'info-box', $settings['_skin'], 'info-box/tpl', $settings, true );
