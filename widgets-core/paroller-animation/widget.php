...
class TM_Elementor_Paroller_Animation extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_script( 'jquery-paroller', MASCOT_CORE_CARPENTO_ASSETS_URI . '/js/plugins/jquery.paroller.min.js', array('jquery'), false, true );
		wp_register_style( 'tm-paroller-style', MASCOT_CORE_CARPENTO_ASSETS_URI . '/css/widgets-core/paroller' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'Paroller Animation', 'mascot-core-carpento' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'paroller_bg',
			[
				'label' => esc_html__( 'Paroller BG Image & Text Animation', 'mascot-core-carpento' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Enable Paroller Background Animation", 'mascot-core-carpento' ),
		...
		$this->add_control(
			'display_type', [
				'label' => esc_html__( "Animation Type", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'layer-text'  =>  esc_html__( 'Text Layer', 'mascot-core-carpento' ),
					'layer-image' =>  esc_html__( 'Image Layer', 'mascot-core-carpento' ),
					'layer-both'  =>  esc_html__( 'Both Text & Image Layers', 'mascot-core-carpento' ),
				],
				'default' => 'layer-text',
				'condition' => [
		...
		$this->add_control(
			'paroller_text',
			[
				'label' => esc_html__( "Paroller Parallax Text", 'mascot-core-carpento' ),
		...
		$this->add_control(
			'paroller_image',
			[
				'label' => esc_html__( "Paroller Parallax Image", 'mascot-core-carpento' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Enable Textillate Text Animation', 'mascot-core-carpento' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
				'condition' => [
					'paroller_bg_animation' => array('yes'),
					'display_type' => array('layer-text', 'layer-both'),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Enable Textillate Animation", 'mascot-core-carpento' ),
		...
		$this->start_controls_section(
			'paroller_styling',
			[
				'label' => esc_html__( 'Styling', 'mascot-core-carpento' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_responsive_control(
			'pos_top',
			[
				'label' => esc_html__( "Top (px or %)", 'mascot-core-carpento' ),
		...
		$this->add_responsive_control(
			'pos_right',
			[
				'label' => esc_html__( "Right (px or %)", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'condition' => [
					'paroller_bg_animation' => array('yes'),
				],
		...
		$this->add_responsive_control(
			'pos_bottom',
			[
				'label' => esc_html__( "Bottom (px or %)", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'condition' => [
					'paroller_bg_animation' => array('yes'),
				],
		...
		$this->add_responsive_control(
			'pos_left',
			[
				'label' => esc_html__( "Left (px or %)", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'condition' => [
					'paroller_bg_animation' => array('yes'),
				],
		...
		$this->start_controls_section(
			'paroller_conf',
			[
				'label' => esc_html__( 'Paroller Configuration', 'mascot-core-carpento' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'paroller_factor',
			[
				'label' => esc_html__( "Paroller Factor", 'mascot-core-carpento' ),
				'type' => Controls_Manager::SLIDER,
				"description" => esc_html__( "Multiplier for scrolling speed and offset. Example: 0.3", 'mascot-core-carpento' ),
				'size_units' => [ '%' ],
				'range' => [
					'%' => [
						'min' => -1,
		...
		$this->add_control(
			'paroller_type',
			[
				'label'        => esc_html__( 'Paroller Type', 'mascot-core-carpento'),
				'type'         => \Elementor\Controls_Manager::SELECT,
				'default'      => 'no',
				'options' => [
					'foreground'    =>  esc_html__( 'Foreground', 'mascot-core-carpento'),
					'background'    =>  esc_html__( 'Background', 'mascot-core-carpento')
				],
				'default'      => 'foreground',
				'condition' => [
					'paroller_bg_animation' => array('yes')
		...
		$this->add_control(
			'paroller_direction',
			[
				'label'        => esc_html__( 'Paroller Direction', 'mascot-core-carpento'),
				'type'         => \Elementor\Controls_Manager::SELECT,
				'default'      => 'no',
				'options' => [
					'horizontal'   =>  esc_html__( 'Horizontal', 'mascot-core-carpento'),
					'vertical'     =>  esc_html__( 'Vertical', 'mascot-core-carpento')
				],
				'default'      => 'horizontal',
				'condition' => [
					'paroller_bg_animation' => array('yes')
		...
		$this->add_control(
			'paroller_transition',
			[
				'label' => esc_html__( "Paroller Transition", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				"description" => esc_html__( "CSS transition. Example: transform .3s ease-out", 'mascot-core-carpento' ),
				'condition' => [
					'paroller_bg_animation' => array('yes')
				]
			]
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Parallax Text/Image Custom CSS class", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'condition' => [
					'paroller_bg_animation' => array('yes')
				]
		...
		$this->add_control(
			'paroller_text_style',
			[
				'label' => esc_html__( "Parallax Text/Image Custom Inline CSS", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				"description" => esc_html__( "Example: color: #f1f1f1; font-size: 120px; line-height: 1; top: 12px; left: 100px", 'mascot-core-carpento' ),
				'condition' => [
					'paroller_bg_animation' => array('yes')
				]
			]
		...
		$this->start_controls_section(
			'stroke_text_style',
			[
				'label' => esc_html__( 'Text Stroke Style', 'mascot-core-carpento' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'show_stroke_text',
			[
				'label' => esc_html__( "Show Stroke in Text?", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'no',
			]
		);
		$this->add_control(
			'text_stroke_size',
			[
				'label' => esc_html__( 'Text Stroke Size', 'mascot-core-carpento' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
			...
			if( ! empty( $settings['paroller_text'] ) || ! empty( $settings['paroller_image'] ) ) {
				...
				if( ! empty( $settings['paroller_image'] ) ) {
					...
					if( !empty($image[0]) ) {
						...
						$output .= '<img src="'.esc_url( $image[0] ).'" alt="'.esc_attr__( 'Image', 'mascot-core-carpento' ).'">';
						$output .= '</div>';
					}
				}
