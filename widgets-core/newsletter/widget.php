...
class TM_Elementor_Newsletter extends Widget_Base {
    public function __construct($data = [], $args = null) {
        ...
        wp_register_style( 'tm-newsletter-style', MASCOT_CORE_CARPENTO_ASSETS_URI . '/css/widgets-core/newsletter' . $direction_suffix . '.css' );
    }
    ...
    public function get_title() {
        return esc_html__( 'TM Mailchimp Newsletter', 'mascot-core-carpento' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'mailchimp_form_id',
            [
                'label'       => esc_html__( 'Type Mailchimp Form ID', 'mascot-core-carpento' ),
                'type'        => Controls_Manager::TEXT,
                'placeholder' => '419',
                'description' => sprintf(__('To collect your Mailchimp Form ID <a href="%s" target="_blank">Click here</a>', 'mascot-core-carpento'), admin_url('admin.php?page=mailchimp-for-wp-forms')),
                'label_block' => true,
                'separator'   => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'classic' => esc_html__( 'Classic', 'mascot-core-carpento' ),
                    'default' => esc_html__( 'Default', 'mascot-core-carpento' ),
                    'round' => esc_html__( 'Round', 'mascot-core-carpento' ),
                    'btn-absolute' => esc_html__( 'Absolute Button', 'mascot-core-carpento' ),
                ],
                'default' => 'flat',
                'separator'   => 'before',
            ]
        ...
        $this->add_control(
            'form_style',
            [
                'label'        => esc_html__( 'Form Style Block', 'mascot-core-carpento' ),
        ...
        $this->add_control(
            'heading_input',
            [
                'label' => esc_html__( 'Input', 'mascot-core-carpento' ),
        ...
        $this->add_control(
            'text_hide',
            [
                'label'        => esc_html__( 'Hide Text', 'mascot-core-carpento' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_off'    => esc_html__( 'Off', 'mascot-core-carpento' ),
                'label_on'     => esc_html__( 'On', 'mascot-core-carpento' ),
                'default'      => '',
        ...
        $this->add_responsive_control(
            'icon_margin',
            [
                'label'      => esc_html__( 'Margin Icon', 'mascot-core-carpento' ),
        ...
        $this->add_responsive_control(
            'width_button',
            [
                'label'      => esc_html__( 'Button width', 'mascot-core-carpento' ),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Input Field Style', 'mascot-core-carpento' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Text Theme Color', 'mascot-core-carpento'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'options' => mascot_core_carpento_theme_color_list(),
                'default' => '',
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Button Style', 'mascot-core-carpento' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Border Theme Color', 'mascot-core-carpento'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'options' => mascot_core_carpento_theme_color_list(),
                'default' => '',
                'selectors' => [
    ...
    protected function render() {
        ...
        ?>
        <div class="tm-mc4wp-newsletter <?php echo esc_attr(implode(' ', $classes)); ?>">
            <?php
                    ...
                    try {
                        ...
                        if( isset($mailchimp_form_id) && $mailchimp_form_id != 0 ) {
                          echo do_shortcode('[mc4wp_form id="'. $mailchimp_form_id .'"]');
                            ...
                            esc_html_e('Please create a newsletter form from Mailchip plugin and collect your Mailchip Form ID', 'mascot-core-carpento');
                        }
                    } catch (Exception $e) {
                        esc_html_e('Please create a newsletter form from Mailchip plugins', 'mascot-core-carpento');
                    }
                }
            ?>
        </div>
