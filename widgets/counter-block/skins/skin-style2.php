<?php
namespace MascotCoreCarpento\Widgets\CounterBlock\Skins;
...
class Skin_Style2 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-counter-block-style2', MASCOT_CORE_CARPENTO_ASSETS_URI . '/css/shortcodes/counter-block/counter-block-style2' . $direction_suffix . '.css' );
		...
		$html = mascot_core_carpento_get_shortcode_template_part( 'counter-skin-style2', null, 'counter-block/tpl', $settings, true );
