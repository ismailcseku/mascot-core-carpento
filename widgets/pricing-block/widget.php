<?php
namespace MascotCoreCarpento\Widgets\PricingBlock;
...
class TM_Elementor_PricingBlock extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		if( \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
			...
			wp_enqueue_style( 'tm-pricing-block-loader', MASCOT_CORE_CARPENTO_ASSETS_URI . '/css/shortcodes/pricing-block/pricing-block-loader' . $direction_suffix . '.css' );
			wp_enqueue_script( 'tm-pricing-block-script', MASCOT_CORE_CARPENTO_ASSETS_URI . '/js/widgets/pricing-block.js' );
		}
	}
	...
	public function get_title() {
		return esc_html__( 'Pricing Block', 'mascot-core-carpento' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'pricing_icons_options', [
				'label' => esc_html__( 'Pricing Items', 'mascot-core-carpento' ),
		...
		$repeater->add_control(
			'image_position', [
				'label' => esc_html__( "Image/Icon Position", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
			...
			[
				...
				'default' => [
					[
						...
						'price' => esc_html__( '$20.00', 'mascot-core-carpento' ),
					],
					[
