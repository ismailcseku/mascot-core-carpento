<?php
namespace MascotCoreCarpento\Widgets\WorkingBlock;
...
class TM_Elementor_WorkingBlock extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		if( \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
			...
			wp_enqueue_style( 'tm-working-block-loader', MASCOT_CORE_CARPENTO_ASSETS_URI . '/css/shortcodes/working-block/working-block-loader' . $direction_suffix . '.css' );
		}
	}
	...
	public function get_title() {
		return esc_html__( 'Working Block', 'mascot-core-carpento' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'working_block_icons_options', [
				'label' => esc_html__( 'Working Block Items', 'mascot-core-carpento' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Working Items", 'mascot-core-carpento' ),
