<?php
namespace MascotCoreCarpento\Widgets\ServiceBlock;
...
class TM_Elementor_ServiceBlock extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		if( \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
			...
			wp_enqueue_style( 'tm-service-block-loader', MASCOT_CORE_CARPENTO_ASSETS_URI . '/css/shortcodes/service-block/service-block-loader' . $direction_suffix . '.css' );
		}
	}
	...
	public function get_title() {
		return esc_html__( 'Service Block', 'mascot-core-carpento' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'service_icons_options', [
				'label' => esc_html__( 'Service Items', 'mascot-core-carpento' ),
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( 'Service Icon Section', 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		$repeater->add_control(
			'icon_type',
			[
				'label' => esc_html__( "Service Icon Type", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
		...
		$repeater->add_control(
			'service_icon_image',
			[
				'label' => esc_html__( "Icon Type - Image", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( "Icon Type - Image (Hover)", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
				'description' => esc_html__( "This image will be shown on the top of the pricing table", 'mascot-core-carpento' ),
				'condition' => [
					'icon_type' => array('image')
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( "Icon Type - Image Size", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_carpento_get_available_image_sizes(),
				'default' => 'full',
				'condition' => [
		...
		$repeater->add_responsive_control(
			...
			[
				'label' => esc_html__( "Icon Image Custom Width", 'mascot-core-carpento' ),
	...
	protected function render() {
		...
		$direction_suffix = is_rtl() ? '.rtl' : '';
		wp_enqueue_style( 'service-block-style1', MASCOT_CORE_CARPENTO_ASSETS_URI . '/css/shortcodes/service-block/service-block-style1' . $direction_suffix . '.css' );
