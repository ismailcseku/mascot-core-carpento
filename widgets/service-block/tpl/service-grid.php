...
<?php if ( $service_items_array ) : ?>
	<div class="tm-sc-service tm-service-grid">
		...
		<div id="<?php echo esc_attr( $holder_id ) ?>" class="isotope-layout grid-<?php echo esc_attr( $columns ); ?> <?php echo esc_attr( $gutter );?>  <?php echo esc_attr(implode(' ', $classes)); ?> clearfix">
