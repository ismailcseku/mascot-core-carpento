<?php
namespace MascotCoreCarpento\Widgets\TeamBlock;
...
class TM_Elementor_TeamBlock extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		if( \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
			...
			wp_enqueue_style( 'tm-team-block-loader', MASCOT_CORE_CARPENTO_ASSETS_URI . '/css/shortcodes/team-block/team-block-loader' . $direction_suffix . '.css' );
		}
	}
	...
	public function get_title() {
		return esc_html__( 'Team Block', 'mascot-core-carpento' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'team_icons_options', [
				'label' => esc_html__( 'Team Items', 'mascot-core-carpento' ),
		...
		$repeater->add_control(
			'title',
			[
				'label' => esc_html__( "Name", 'mascot-core-carpento' ),
		...
		$repeater->add_control(
			'subtitle',
			[
				'label' => esc_html__( "Sub Title/ Job Title", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::TEXT,
		...
		$repeater->add_control(
			'phone',
			[
				'label' => esc_html__( "Phone Number", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( "+123456789", 'mascot-core-carpento' ),
			]
		);
		$repeater->add_control(
			'feature_link',
			[
				'label' => esc_html__( "Title Link URL", 'mascot-core-carpento' ),
		...
		$repeater->add_control(
			'featured_image_size',
			[
				'label' => esc_html__( "Thumbnail Image Size", 'mascot-core-carpento' ),
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( 'Social Links', 'mascot-core-carpento' ),
		...
		$repeater->add_control(
			'facebook',
			[
				'label' => esc_html__( "Facebook", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::TEXT,
			]
		);
		$repeater->add_control(
			'twitter',
			[
				'label' => esc_html__( "Twitter", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::TEXT,
			]
		);
		$repeater->add_control(
			'instagram',
			[
				'label' => esc_html__( "Instagram", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::TEXT,
			]
		);
		$repeater->add_control(
			'linkedin',
			[
				'label' => esc_html__( "Linkedin", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::TEXT,
			]
		);
		$repeater->add_control(
			'github',
			[
				'label' => esc_html__( "Github", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::TEXT,
			]
		);
		$repeater->add_control(
			'youtube',
			[
				'label' => esc_html__( "Youtube", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::TEXT,
			]
		);
		$repeater->add_control(
			'short_bio',
			[
				'label' => esc_html__( "Short Bio", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::TEXTAREA,
				'default' => esc_html__( "Write a short bio, that will describe the title or something informational and useful.", 'mascot-core-carpento' ),
				'separator' => 'before',
			]
		);
		$repeater->add_control(
		...
		$this->add_control(
			'subtitle_tag',
			[
				'label' => esc_html__( "Sub Title/ Job Title Tag", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_carpento_heading_tag_list(),
				'default' => 'div'
			]
		...
		$this->add_control(
			'show_subtitle', [
				'label' => esc_html__( "Show Sub Title/ Job Title", 'mascot-core-carpento' ),
		...
		$this->add_control(
			'show_short_bio', [
				'label' => esc_html__( "Show Short Bio", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'no'
			]
		);
		$this->add_control(
			'show_social_links', [
				'label' => esc_html__( "Show Social Links", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes'
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Name Styling', 'mascot-core-carpento' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Sub Title/ Job Title Styling', 'mascot-core-carpento' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Short Bio Styling', 'mascot-core-carpento' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			'icon_custom_styling',
			[
				'label' => esc_html__( 'Social Links Styling', 'mascot-core-carpento' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
