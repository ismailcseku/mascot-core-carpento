...
class Skin_Style2 extends Elementor_Skin_Base {
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->start_controls_section(
			'default_options',
			[
				'label' => esc_html__( 'Default Settings', 'mascot-core-carpento' ),
        ...
        $this->add_control(
            'round_button',
            [
                'label' => esc_html__( 'Round Button', 'mascot-core-carpento' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Button Active/Hover Options', 'mascot-core-carpento' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
