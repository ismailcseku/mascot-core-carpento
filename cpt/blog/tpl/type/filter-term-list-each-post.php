<?php
	...
	if ( $use_masonry_tiles_featured_image_size == 'yes' ) :
		$settings['featured_image_size'] = $meta_featured_image_size = carpento_get_rwmb_group( 'carpento_' . "portfolio_mb_featured_image_size_settings", 'masonry_tiles_featured_image_size' );

		$masonry_tiles_image_size_class = 'tm-masonry-default';
		switch ( $meta_featured_image_size ) {
			case 'carpento_height':
				# code...
