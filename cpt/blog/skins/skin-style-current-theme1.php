...
class Skin_Style_Current_Theme1 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style Current Theme1', 'mascot-core-carpento' );
	}
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Content Wrapper Styling', 'mascot-core-carpento' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Custom Border Color", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-blog-skin-style-current-theme1', MASCOT_CORE_CARPENTO_ASSETS_URI . '/css/cpt/blog/blog-skin-style-current-theme1' . $direction_suffix . '.css' );
