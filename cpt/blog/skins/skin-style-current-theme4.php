...
class Skin_Style_Current_Theme4 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style Current Theme4', 'mascot-core-carpento' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-blog-skin-style-current-theme4', MASCOT_CORE_CARPENTO_ASSETS_URI . '/css/cpt/blog/blog-skin-style-current-theme4' . $direction_suffix . '.css' );
