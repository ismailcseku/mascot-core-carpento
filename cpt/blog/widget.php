<?php
namespace MascotCoreCarpento\Widgets\Blog;
...
class TM_Elementor_Blog extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		if( \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
			...
			wp_enqueue_style( 'tm-blog-style', MASCOT_CORE_CARPENTO_ASSETS_URI . '/css/cpt/blog/blog-loader' . $direction_suffix . '.css' );
		}
	}
	...
	public function get_title() {
		return esc_html__( 'Blog/News Grid', 'mascot-core-carpento' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'display_type', [
				...
				'options' => [
					...
					'floating-parallax'  =>  esc_html__( 'Floating Parallax', 'mascot-core-carpento' )
				],
				'default' => 'grid'
			]
		);
		...
		$this->add_control(
			'use_masonry_tiles_featured_image_size', [
				'label' => esc_html__( "Use Predefined Image Size in Masonry Mode", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				"description" => esc_html__( "You can select predefined image size from each items edit page. If you choose yes, then 'Featured Image Size' will not work", 'mascot-core-carpento' ),
				'default' => 'yes',
				'condition' => [
		...
		$this->start_controls_section(
			'content',
			[
				'label' => esc_html__( 'All Items(Content) Show/Hide', 'mascot-core-carpento' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Show This Meta Over Thumbnail", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => $post_meta_array,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Single Meta Styling', 'mascot-core-carpento' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
	...
	protected function render() {
		...
		$settings['holder_id'] = carpento_get_isotope_holder_ID('blog');
	...
	public function render_output( $class_instance, $settings ) {
		...
		$html = mascot_core_carpento_get_cpt_shortcode_template_part( 'blog', $settings['display_type'], 'blog/tpl/type', $settings, true );
