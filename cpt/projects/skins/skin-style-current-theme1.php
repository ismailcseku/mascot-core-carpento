...
class Skin_Style_Current_Theme1 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-project-skin-current-theme1', MASCOT_CORE_CARPENTO_ASSETS_URI . '/css/cpt/projects/project-skin-current-theme1' . $direction_suffix . '.css' );

		wp_enqueue_script( 'tm-projects-block-script', MASCOT_CORE_CARPENTO_ASSETS_URI . '/js/cpt/project-block.js', array('jquery'), false, true );
