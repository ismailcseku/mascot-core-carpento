<?php
namespace MASCOTCORECARPENTO\CPT;

use MASCOTCORECARPENTO\Lib;

/**
 * class Reg_Post_Type
 * @package MASCOTCORECARPENTO\CPT;
 */
class Reg_Post_Type {
	/**
	 ...
	 */
	private function add_new_post_type(Lib\Mascot_Core_Carpento_Interface_PostType $newPostType) {
...
add_action('elementor/init','MASCOTCORECARPENTO\CPT\tm_enable_elementor_for_all_cpt');