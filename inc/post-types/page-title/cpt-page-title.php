<?php
namespace MASCOTCORECARPENTO\CPT\PageTitle;
 ...
 * Singleton class
 * class CPT_PageTitle
 * @package MASCOTCORECARPENTO\CPT\PageTitle;
 */
final class CPT_PageTitle implements Lib\Mascot_Core_Carpento_Interface_PostType {
	...
	private function __construct() {
		$this->ptSingularName = esc_html__( 'Parts - Page Title', 'mascot-core-carpento' );
		$this->ptPluralName = esc_html__( 'Parts - Page Title', 'mascot-core-carpento' );
	...
	public function customColumnsSettings( $columns ) {
		...
		$columns = array(
			...
			'active-page-title'	=> esc_html__( 'Currently Active Page Title', 'mascot-core-carpento' ),
		...
		switch( $columns ) {
			case 'active-page-title' :
				if( mascot_core_carpento_theme_installed() ) {
					$active_headertop_id = carpento_get_redux_option( 'page-title-settings-choose-page-title-cpt-widget-area', 'default' );
