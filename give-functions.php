...
function mascot_core_carpento_goal_progress($form_id, $args) {
...
function mascot_core_carpento_give_progress_bar($total_earnings, $total_goal) {
  // Total Earnings.
...
function mascot_core_carpento_give_amount_formatted($amount) {
