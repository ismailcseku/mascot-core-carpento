...
class TM_Elementor_InfoBanner extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-info-banner-advanced-style', MASCOT_CORE_CARPENTO_ASSETS_URI . '/css/woo/info-banner-advanced/info-banner-advanced' . $direction_suffix . '.css' );
		wp_register_script( 'tm-info-banner-advanced-script', MASCOT_CORE_CARPENTO_ASSETS_URI . '/js/woo/info-banner.js' );
	}
	...
	*/
	public function get_title() {
		return esc_html__( 'Info Banner', 'mascot-core-carpento' );
	}
  	...
  	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'options' => [
					'layout-top-reveal' => esc_html__( 'Top Reveal', 'mascot-core-carpento' ),
					'layout-center'  => esc_html__( 'Center Standard', 'mascot-core-carpento' ),
					'layout-bottom'  => esc_html__( 'From Bottom', 'mascot-core-carpento' ),
					'layout-image-switch'  => esc_html__( 'Image Switch', 'mascot-core-carpento' ),
					'layout-basic'  => esc_html__( 'Basic', 'mascot-core-carpento' ),
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Flex Options', 'mascot-core-carpento' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Flex Vertical Alignment", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Flex Horizontal Alignment", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( "Example title", 'mascot-core-carpento' ),
			]
		);
		$this->add_control(
			'title_tag',
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXTAREA,
				'default' => esc_html__( "Example subtitle", 'mascot-core-carpento' ),
				'condition' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Sub Title Vertical Alignment", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_carpento_disply_flex_vertical_align_elementor(),
				'default' => '',
				'selectors' => [
		...
		$repeater->add_control(
			'subtitle_other_text',
			[
				'label' => esc_html__( "Subtitle Text", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::TEXTAREA,
			]
		);
		$repeater->add_control(
		...
		$this->add_control(
			'subtitle_list',
			[
				'label' => esc_html__( "Subtitle Other Parts", 'mascot-core-carpento' ),
		...
		$this->start_controls_section(
			'paragraph_opt',
			[
				'label' => esc_html__( 'Content - Paragraph', 'mascot-core-carpento' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( "Write a short description", 'mascot-core-carpento' ),
				'condition' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Background Image/Color', 'mascot-core-carpento' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Background Overlay', 'mascot-core-carpento' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Floating PNG Image', 'mascot-core-carpento' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Floating PNG Image (Hover)", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Floating Image Size", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Animation', 'mascot-core-carpento'),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Hover Crystal Animation Effect", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'hover-linear-crystal-animation' => esc_html__( 'Linear Crystal Animation', 'mascot-core-carpento' ),
					'hover-cross-crystal-animation' => esc_html__( 'Cross/Plus Crystal Animation', 'mascot-core-carpento' ),
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Enable Background Zoom Effect', 'mascot-core-carpento' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Show Circle Animation', 'mascot-core-carpento' ),
				'type' => Controls_Manager::SWITCHER,
				'separator' => 'before',
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Circle Background Color', 'mascot-core-carpento'),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Circle Opacity', 'mascot-core-carpento' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 1,
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Show Inner Border Around Wrapper', 'mascot-core-carpento' ),
				'type' => Controls_Manager::SWITCHER,
				'separator' => 'before',
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Inner Border Around Wrapper', 'mascot-core-carpento' ),
		...
		$this->add_control(
			'link',
			[
				'label' => esc_html__( "Button Link URL", 'mascot-core-carpento' ),
		...
		$this->add_control(
			'link_subtitle',
			[
				'label' => esc_html__( "Link to Subtitle?", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'no',
			]
		);
		$this->add_control(
			'link_title',
			[
				'label' => esc_html__( "Link to Title?", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'no',
			]
		);
		...
		$this->start_controls_section(
			'button_options',
			[
				'label' => esc_html__( 'Button', 'mascot-core-carpento' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'link_icon_title',
			[
				'label' => esc_html__( "Link Icon, Title and Button?", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'no',
			]
		);
		...
		mascot_core_carpento_get_button_arraylist($this, 13);
		mascot_core_carpento_get_button_arraylist($this, 14);
		mascot_core_carpento_get_button_arraylist($this, 15);
		$this->end_controls_section();
		...
		$this->start_controls_section(
			'button_icon_options', [
				'label' => esc_html__( 'Button Icon', 'mascot-core-carpento' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'add_btnicon_left',
			[
				'label' => esc_html__( "Show Button Icon Left?", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'separator' => 'before',
			]
		);
		$this->add_control(
			'button_icon_left',
			[
				'label' => esc_html__( 'Icon Left', 'mascot-core-carpento' ),
		...
		$this->add_control(
			'add_btnicon_right',
			[
				'label' => esc_html__( "Show Button Icon Right?", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'separator' => 'before',
			]
		);
		$this->add_control(
			'button_icon_right',
			[
				'label' => esc_html__( 'Icon Right', 'mascot-core-carpento' ),
				'type' => Controls_Manager::ICONS,
				'fa4compatibility' => 'icon',
				'default' => [
					'value' => 'fas fa-chevron-right',
		...
		$this->add_responsive_control(
			'btn_icon_font_size',
			[
				'label' => esc_html__('Font Size', 'mascot-core-carpento'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Border Around Wrapper', 'mascot-core-carpento' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->end_controls_section();
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Banner Wrapper Style', 'mascot-core-carpento' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Wrapper Height", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => ['px', 'em', '%'],
				'range' => [
					'px' => [
	...
	*/
	protected function render() {
		...
		$html = mascot_core_carpento_get_shortcode_shop_template_part( 'info-banner', $settings['layout'], 'info-banner/tpl', $settings, true );
