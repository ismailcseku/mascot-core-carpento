...
class TM_Elementor_Header_Cart extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_enqueue_style( 'carpento-woo-shop-mini-cart' );
		wp_enqueue_style( 'tm-header-cart', MASCOT_CORE_CARPENTO_ASSETS_URI . '/css/woo/header-cart' . $direction_suffix . '.css' );
		wp_enqueue_script('tm-header-cart', MASCOT_CORE_CARPENTO_ASSETS_URI . '/js/woo/header-cart.js', array('jquery'), MASCOT_CORE_CARPENTO_VERSION, true);
	}
	...
	public function get_title() {
		return esc_html__( 'Header Cart', 'mascot-core-carpento' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                'label'   => esc_html__('Dropdown Content Style', 'mascot-core-carpento'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'style-dropdown',
                'options' => [
                    'style-dropdown' => esc_html__('Dropdown', 'mascot-core-carpento'),
                    'style-no-dropdown' => esc_html__('No Dropdown Content', 'mascot-core-carpento'),
                    'style-side-panel'    => esc_html__('Side Panel', 'mascot-core-carpento'),
                ],
        ...
        $this->add_control(
            'show_price',
            [
                'label' => esc_html__( 'Hide Price', 'mascot-core-carpento' ),
        ...
        $this->add_control(
            'show_count',
            [
                'label' => esc_html__( 'Hide Count Items Label', 'mascot-core-carpento' ),
                'type' => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'show_mini_count',
            [
                'label' => esc_html__( 'Hide Mini Count', 'mascot-core-carpento' ),
                'type' => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'show_dropdown',
            [
                'label' => esc_html__( 'Hide Dropdown', 'mascot-core-carpento' ),
                'type' => Controls_Manager::SWITCHER,
		...
		$this->add_responsive_control(
			'cart_alignment',
			[
				'label' => esc_html__('Cart Alignment', 'mascot-core-carpento'),
		...
		$this->start_controls_section(
			'price_text_options',
			[
				'label' => esc_html__( 'Price Text', 'mascot-core-carpento' ),
        ...
        $this->add_control(
            'count_color',
            [
                'label' => esc_html__('Count Color', 'mascot-core-carpento'),
        ...
        $this->add_control(
            'price_color',
            [
                'label' => esc_html__('Price Color', 'mascot-core-carpento'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
		...
		$this->start_controls_section(
			'mini_cart_options',
			[
				'label' => esc_html__( 'Cart FlatIcon', 'mascot-core-carpento' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Mini Count', 'mascot-core-carpento' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Count BG Color", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Count BG Color (Hover)", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Count BG Theme Colored", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_carpento_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Count BG Theme Colored (Hover)", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_carpento_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Count Text Color", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Count Text Color (Hover)", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Count Text Theme Colored", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_carpento_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Item Count Text Theme Colored (Hover)", 'mascot-core-carpento' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_carpento_theme_color_list(),
				'default' => '',
				'selectors' => [
        ...
        $this->add_responsive_control(
            'icon_bg_size',
            [
                'label'     => esc_html__('Background Size', 'mascot-core-carpento'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 20,
	...
	protected function render() {
		...
		$html = mascot_core_carpento_get_shortcode_shop_template_part( 'header-cart', null, 'header-cart/tpl', $settings, true );
